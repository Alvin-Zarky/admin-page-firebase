...
import { DataCategory, getCategoryAction, searchCategoryAction } from '../../actions/interfaceAction'
import { useParams } from 'react-router-dom'
import Loading from '../../components/Loading'
import { Router } from '../../router'
import '../add-category/add-category.scss'

interface ParamKeyword{
  keyword:string | any
}
export default function LiveSearchCategory() {
  ...
  const {isLoading}= useSelectorHook(state => state.getCategory)
  const {category:dataCategorySearch, message} = useSelectorHook(state => state.searchCategory)
  ...
  const {keyword} = useParams<ParamKeyword>()
  ...
  useEffect(() =>{
    ...
    if(keyword){
      dispatch(searchCategoryAction(keyword) as any)
    }
  }, [dispatch, user, keyword])
              ...
              <div className="table-content">
                <Table bordered>
                  ...
                  <tbody>
                    ...
                    {dataCategorySearch && dataCategorySearch.map((value:DataCategory, ind:number) =>(
                      <tr key={ind}>
                          <td>{value.id}</td>
